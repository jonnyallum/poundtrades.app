...
export const useAuthStore = create((set, get) => ({
  ...
  bypassLogin: async () => {
    const mockUser = {
      id: 'dev-guest-id',
      email: 'guest@poundtrades.com',
      user_metadata: { role: 'private' }
    };
    ...
    await safeSetItem('user', JSON.stringify(mockUser));
    await safeSetItem('userProfile', JSON.stringify(mockProfile));
    return { success: true };
  }
}));
